#!/bin/bash
#$ -N Demultiplex-with-CASAVA-augmented-2012-03-29.1
#$ -P nne-790-ab
#$ -l h_rt=48:00:00
#$ -pe default 8
#$ -cwd
...
outputDirectory=$sequenceWorld/$run/Demultiplex-with-CASAVA-augmented-2012-03-29.1
...
configureBclToFastq.pl --input-dir $sequenceWorld/$run/Data/Intensities/BaseCalls \
 ...
 --use-bases-mask $baseMask --mismatches 1,1 
